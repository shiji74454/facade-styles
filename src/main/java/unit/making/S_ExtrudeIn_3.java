...
public class S_ExtrudeIn_3 extends BasicObject {


    WB_Point[] rectPts;

    public S_ExtrudeIn_3(WB_Point[] rectPts) {
    ...
    protected void calculate() {
        ...
        StyledPolyLine styledPolyLine = new StyledPolyLine(0x00000000,1).add(frame);
