...
public class S_Corner_Component_TestGUI extends PApplet {
    CameraController cam;
    WB_Render3D render;
    ControlPanel panel;
    S_Corner_Component example;
    ...
    public static void main(String[] args) {
        PApplet.main(S_Corner_Component_TestGUI.class.getName());
    }
    ...
    public void setup() {
        ...
        example = new S_Corner_Component(pts);
