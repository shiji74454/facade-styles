...
import unit.making.S_ExtrudeIn_2;
import wblut.geom.WB_Point;
import wblut.geom.WB_Polygon;
import wblut.processing.WB_Render3D;

public class S_2_TestGUI extends PApplet {
    CameraController cam;
    WB_Render3D render;
    ControlPanel panel;
    S_ExtrudeIn_2 example;
    ...
    public static void main(String[] args) {
        PApplet.main(S_2_TestGUI.class.getName());
    }
